...
import { ChartJSAreaInput, ChartJSAreaInputProps } from "./components/ChartJSAreaInput";
...
function transformProps(props: ChartJSAreaPreviewProps): ChartJSAreaInputProps {
...
export function preview(props: ChartJSAreaPreviewProps): ReactElement {
    return (
        <div ref={parentInline}>
            <ChartJSAreaInput {...transformProps(props)} />
        </div>
    );
}

export function getPreviewCss(): string {
    return require("./ui/ChartJSArea.css");
}
