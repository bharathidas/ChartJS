...
import { ChartJSLineContainerProps } from "../typings/ChartJSLineProps";

import { ChartJSLineInput } from "./components/ChartJSLineInput";

import "./ui/ChartJSLine.css";

export function ChartJSLine(
    props: ChartJSLineContainerProps
): ReactElement {
    const {
        seriesList,
        chartTitle,
    ...
    const multiAxisEnabled =
        props.enableMultiAxis?.value ?? false;
    ...
    return (
        <ChartJSLineInput
            ...
            enableMultiAxis={multiAxisEnabled}
