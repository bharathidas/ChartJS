...
import { ChartJSLineInput, ChartJSLineInputProps } from "./components/ChartJSLineInput";
import { ChartJSLinePreviewProps } from "../typings/ChartJSLineProps";
...
function transformProps(props: ChartJSLinePreviewProps): ChartJSLineInputProps {
...
export function preview(props: ChartJSLinePreviewProps): ReactElement {
    return (
        <div ref={parentInline}>
            <ChartJSLineInput {...transformProps(props)} />
        </div>
    );
}

export function getPreviewCss(): string {
    return require("./ui/ChartJSLine.css");
}
