/**
 * This file was generated from ChartJSBar.xml
...
export interface ChartJSBarContainerProps {
    name: string;
    class: string;
    style?: CSSProperties;
    tabIndex?: number;
    ...
    stacked?: EditableValue<boolean>;
    horizontal?: EditableValue<boolean>;
...
export interface ChartJSBarPreviewProps {
    /**
